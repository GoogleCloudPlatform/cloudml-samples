...
def transform_data(
    ...
    with beam.Pipeline(options=pipeline_options) as pipeline:
        ...
        with beam_impl.Context(tmp_dir):
            ...
            _ = transform_fn | "WriteTransformFn" >> transform_fn_io.WriteTransformFn(
                working_dir
            )
...
def main(argv=None):
    ...
    parser.add_argument(
        "--train-data-file", help="Path to training data", required=True
    )
    parser.add_argument("--test-data-file", help="Path to test data", required=True)
    parser.add_argument(
        "--root-train-data-out", help="Root for files with train data", required=True
    )
    parser.add_argument(
        "--root-test-data-out", help="Root for files with test data", required=True
    )
    parser.add_argument(
        "--working-dir",
