...
flags.DEFINE_bool(
    ...
    default=True,
    help=(
        "Use TPU to execute the model for training and evaluation. If"
...
flags.DEFINE_string(
    ...
    default=None,
    help=(
        "The directory where the ImageNet input data is stored. Please see"
...
flags.DEFINE_integer(
    ...
    default=112603,
    help=(
        "The number of steps to use for training. Default is 112603 steps"
...
flags.DEFINE_integer(
    ...
    default=8,
    help=(
        "Number of TPU cores. For a single TPU device, this is 8 because each"
...
# by default for TPU
flags.DEFINE_bool(
    "transpose_input", default=True, help="Use TPU double transpose optimization"
)
...
flags.DEFINE_float(
    "momentum", default=0.9, help=("Momentum parameter used in the MomentumOptimizer.")
)
...
def main(unused_argv):
    ...
    if trial_id:
        ...
        FLAGS.model_dir = os.path.join(FLAGS.model_dir, "trial_{}".format(trial_id))
    ...
    assert (
        FLAGS.precision == "bfloat16" or FLAGS.precision == "float32"
    ...
    if FLAGS.mode == "eval":
        ...
        if FLAGS.mode == "train":
            ...
            while current_step < FLAGS.train_steps:
                ...
                next_checkpoint = min(
                    current_step + FLAGS.steps_per_eval, FLAGS.train_steps
                )
                tf.logging.info("Training for trial_{}".format(trial_id))
                resnet_classifier.train(
