...
def input_fn(params, eval_batch_size=None):
  ...
  # NOTE: it's a performance fix that has not been submitted in CloudTPU sample.
  dataset = dataset.apply(
      sloppy_ops.sloppy_interleave,
      args=(prefetch_dataset,),
      kwargs={
  ...
  # TODO(wenzhel): Consider removing the sharding dimension below.
