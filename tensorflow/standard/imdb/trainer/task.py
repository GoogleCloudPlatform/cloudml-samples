...
def train_and_evaluate(hparams):
    ...
    """
    # Load data.
    (train_data, train_labels), (test_data, test_labels) = utils.preprocess(
        train_data_file=hparams.train_file,
    ...
    eval_spec = tf.estimator.EvalSpec(
        input_fn=lambda: model.input_fn(
            test_data, test_labels, hparams.batch_size, mode=tf.estimator.ModeKeys.EVAL
        ),
        steps=None,
        exporters=exporter,
        start_delay_secs=10,
