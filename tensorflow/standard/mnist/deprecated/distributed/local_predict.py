...
def local_predict(args):
    ...
    for input_file in args.input:
        ...
        if args.dry_run:
            print("Feed data dict %s to graph and fetch %s" % (feed_dict, tensor_names))
        else:
...
def parse_args():
    ...
    argparser.add_argument(
        ...
        nargs="+",
        help=(
            "The input data file/file patterns. Multiple "
    ...
    argparser.add_argument(
        ...
        dest="model_dir",
        help=(
            "The path to the model where the tensorflow meta graph "
