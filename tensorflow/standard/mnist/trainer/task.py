...
def get_args():
    ...
    parser.add_argument(
        "--train-file", type=str, required=True, help="Training file local or GCS"
    )
    parser.add_argument(
        "--train-labels-file",
        type=str,
    ...
    parser.add_argument(
        "--test-file", type=str, required=True, help="Test file local or GCS"
    )
    parser.add_argument(
        "--test-labels-file", type=str, required=True, help="Test file local or GCS"
    )
    parser.add_argument(
        "--num-epochs",
        type=float,
...
def train_and_evaluate(hparams):
    ...
    """
    # Loads data.
    (train_images, train_labels), (test_images, test_labels) = utils.prepare_data(
