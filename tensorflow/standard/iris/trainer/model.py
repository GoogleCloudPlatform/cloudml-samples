...
def build_estimator(config, hidden_units=None, learning_rate=1e-4, num_classes=3):
...
def _make_input_parser(with_target=True):
    ...
    def _decode_csv(line):
        ...
        record_defaults = [[0.0] for _ in xrange(len(column_names) - 1)]
...
def input_fn(filename, batch_size=32, shuffle=False):
    ...
    def _input_fn():
        ...
        dataset = (
            ...
            .skip(1)  # Skip the first line (which does not have data)
