...
# ******************************************************************************
# YOU NEED NOT TO CHANGE THIS FUNCTION TO CREATE FEATURE COLUMNS
# ******************************************************************************
...
def _create_feature_columns():
  ...
  Returns:
    list of feature_columns
  """

  # Used to normalize numerical features based on the stast in the metadata
  def _normalizer_fn(value, mean, variance):
  ...
  for feature_name in metadata.NUMERIC_FEATURE_NAMES_WITH_STATS:
    ...
    feature_columns.append(
      tf.feature_column.numeric_column(
        feature_name, lambda value: _normalizer_fn(value, mean, variance)))
...
# ******************************************************************************
# YOU NEED NOT TO CHANGE THESE FUNCTIONS TO DEFINE WIDE AND DEEP COLUMNS
# ******************************************************************************
...
def _get_sparse_and_dense_columns(feature_columns):
  ...
  dense_columns = [
    ...
    if (
      ...
      isinstance(column, feature_column.indicator_column))
  ]
